...
from backend.filters.controllers.get_snapshot_proposals import (
    GetSnapshotProposalsController,
)


class GetSnapshotProposalsView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = GetSnapshotProposalsController(request.query_params, request.user, *args, **kwargs)
        result = controller.get_snapshot_proposals()
