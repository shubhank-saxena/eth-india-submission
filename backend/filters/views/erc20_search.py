...
from backend.filters.controllers.erc20_search import ERC20SearchController


class ERC20SearchView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = ERC20SearchController(request.query_params, request.user, *args, **kwargs)
        result = controller.search_token()
