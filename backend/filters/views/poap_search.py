...
from backend.filters.controllers.poap_search import POAPSearchController


class POAPSearchView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = POAPSearchController(request.query_params, request.user, *args, **kwargs)
        result = controller.search_poap()
