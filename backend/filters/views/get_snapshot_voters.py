...
from backend.filters.controllers.get_snapshot_voters import GetSnapshotVotersController


class GetSnapshotVotersView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = GetSnapshotVotersController(request.query_params, request.user, *args, **kwargs)
        result = controller.get_snapshot_voters()
