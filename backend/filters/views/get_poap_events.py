...
from backend.filters.controllers.get_poap_events import GetPOAPsController


class GetPOAPsView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = GetPOAPsController(request.query_params, request.user, *args, **kwargs)
        result = controller.get_poaps()
