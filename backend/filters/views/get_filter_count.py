...
from backend.filters.controllers.get_filter_count import GetFilterCountController


class GetFilterCountView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        controller = GetFilterCountController(request.data, request.user, *args, **kwargs)
        result = controller.get_filter_count()
