...
from backend.filters.controllers.get_snapshot_choices import (
    GetSnapshotChoicesController,
)


class GetSnapshotChoicesView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = GetSnapshotChoicesController(request.query_params, request.user, *args, **kwargs)
        result = controller.get_snapshot_choices()
