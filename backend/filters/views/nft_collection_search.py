...
from backend.filters.controllers.nft_collection_search import (
    NFTCollectionSearchController,
)


class NFTCollectionSearchView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = NFTCollectionSearchController(request.query_params, request.user, *args, **kwargs)
        result = controller.search_collection()
