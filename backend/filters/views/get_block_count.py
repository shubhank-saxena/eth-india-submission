...
from backend.filters.controllers.get_block_count import GetBlockCountController


class GetBlockCountView(APIView):
    ...
    def post(self, request, *args, **kwargs):
        controller = GetBlockCountController(request.data, request.user, *args, **kwargs)
        result = controller.get_block_count()
