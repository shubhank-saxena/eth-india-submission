...
from backend.filters.controllers.search_snapshot import SnapshotSearchController
...
class SnapshotSearchView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = SnapshotSearchController(request.query_params, request.user, *args, **kwargs)
        result = controller.search_snapshot()
