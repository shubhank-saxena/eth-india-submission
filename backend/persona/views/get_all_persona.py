...
from backend.persona.controllers.get_all_persona import GetAllPersonaController


class GetAllPersonaView(APIView):
    ...
    def get(self, request, *args, **kwargs):
        controller = GetAllPersonaController(request.query_params, request.user, *args, **kwargs)
        result = controller.get_all_persona()
